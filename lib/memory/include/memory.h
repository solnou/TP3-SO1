...
/**
 * @brief Configura el modo de asignación de memoria (First Fit, Best Fit o
 * Worst Fit).
 *
...
/**
 * @brief Reporta el tamaño total de bloques asignados y la cantidad de memoria
 * libre.
 *
 * @param total_allocated Puntero para almacenar el total de memoria asignada.
 * @param total_free Puntero para almacenar el total de memoria libre.
 * @param block_free Puntero para almacenar la cantidad de bloques libres.
 * @param calidad Puntero para almacenar la calidad de la memoria libre.
 */
